    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <header className="flex items-center justify-between px-6 py-4 md:px-12">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold" data-levered-id="f4af21cbbc">moss</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-2xl">
          ...
          <button
            onClick={handleBack}
            className="mt-8 flex items-center gap-2 text-foreground hover:text-primary transition-colors" data-levered-id="8139123608">

              <ChevronLeft className="w-5 h-5" />
              <span data-levered-id="8a73d776e6">Back</span>
            </button>
          }
        </div>
      </main>
